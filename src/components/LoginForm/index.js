      ...
      <>
        <div className="mainCon">
          <div className="image-con">
            <img
              src="https://res.cloudinary.com/dubzjmgsy/image/upload/v1677209227/Insta%20clone/OBJECTS_wo2mzs.jpg"
              alt="website login"
          ...
          <form className="form-con" onSubmit={this.submitForm}>
            <div className="login-subCon">
              <div className="logo-con">
                <img
                  src="https://res.cloudinary.com/dubzjmgsy/image/upload/v1677209610/Insta%20clone/Standard_Collection_8_1_xxkuqo.jpg"
                  alt="website logo"
                  className="logo"
                />
